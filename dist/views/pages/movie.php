<div class="ratingContainer">
    ...
    <h2 class="col-lg-offset-1">Phase 1 - 2008/2012</h2>
    ...
    <div class="rating col-lg-offset-2">
        ...
        <div class="lacetRed-2 col-lg-offset-2">100 000$</div>
        <div class="bubble col-lg-offset-6"></div>

    </div>
    <div class="rating col-lg-offset-2">
        <div class="col-lg-offset-1">Thor</div>
        <div class="lacetRed-3 col-lg-offset-2">100 000$</div>
    ...
    <h2 class="col-lg-offset-1">Phase 2 - 20013/2015</h2>
